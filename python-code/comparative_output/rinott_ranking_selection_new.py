...
designs = [
    ...
    # X(Ni-n0) updated from step2_pairwise_2.csv differences,
    # anchored to S2_14_R2 X_add = 0.366 (1 additional observation, most stable).
    # Differences applied: N12R2-N14R2=-0.0047, N12R3-N14R2=+0.0057, N14R3-N14R2=+0.0150
...
def pairwise_significance_table():
    """
    Print the pairwise significance results from step2_pairwise_2.csv.
    3 out of 6 pairs are statistically significant in the updated run.
    """
    print("=" * 80)
